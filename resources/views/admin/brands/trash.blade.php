        ...
        <div class="col-xl-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.brands.index') }}">{{ trans('brand.brands') }}</a>
                    </li>
                    <li class="breadcrumb-item active">{{ trans('brand.trashed_brands') }}</li>
                </ol>
            </nav>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('brand.trashed_brands') }}</h4>

                        <a class="btn btn-primary text-white" href="{{ route('admin.brands.index') }}">
                            {{ trans('brand.brands') }}
                        </a>
                    </div>
                </div>
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            ...
                            <tbody>
                                @foreach ($brands as $brand)
                                    <tr>
                                        <td><img width="50" height="50" src="{{ $brand->img_path }}" alt="">
                                        </td>
                                        <td>{{ $brand->name }}</td>
