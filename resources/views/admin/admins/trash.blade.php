        ...
        <div class="col-xl-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ trans('admin.trashed_admins') }}</li>
                </ol>
            </nav>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('admin.trashed_admins') }}</h4>

                        <a class="btn btn-primary text-white" href="{{ route('admin.admins.index') }}">
                            {{ trans('admin.admins') }}
                        </a>
                    </div>
                </div>
