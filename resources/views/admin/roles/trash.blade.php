        ...
        <div class="col-xl-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ trans('roles.trashed_roles') }}</li>
                </ol>
            </nav>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('roles.trashed_roles') }}</h4>

                        <a class="btn btn-primary text-white" href="{{ route('admin.roles.index') }}">
                            {{ trans('roles.roles') }}
                        </a>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($roles as $role)
                                    <tr>
                                        ...
                                        @can('restore_role')
                                            <td class="row pl-3">
                                                <a href="{{ route('admin.roles.restore', $role->id) }}" class="btn btn-primary"
