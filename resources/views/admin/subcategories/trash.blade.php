        ...
        <div class="col-xl-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ trans('category.trashed_subcategories') }}</li>
                </ol>
            </nav>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('category.trashed_subcategories') }}</h4>

                        <a class="btn btn-primary text-white" href="{{ route('admin.subcategories.index', $category) }}">
                                ...
                                @foreach ($subcategories as $subcategory)
                                    <tr>
                                        ...
                                        @can('restore_category')
                                            <td class="row pl-3">
                                                <a href="{{ route('admin.subcategories.restore', ['category' => $category, 'slug' => $subcategory->slug]) }}"
