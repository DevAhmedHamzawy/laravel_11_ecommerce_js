...
@section('title')
    {{ trans('category.update_subcategory') }}
@endsection
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ trans('category.update_subcategory') }}</li>
                </ol>
            </nav>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="main-content-label mg-b-5">
                        {{ trans('category.update_subcategory') }} {{ $subcategory->name }} {{ trans('category.of') }}
