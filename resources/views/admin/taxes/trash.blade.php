        ...
        <div class="col-xl-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.taxes.index') }}">{{ trans('tax.taxes') }}</a>
                    </li>
                    <li class="breadcrumb-item active">{{ trans('tax.trashed_taxes') }}</li>
                </ol>
            </nav>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('tax.trashed_taxes') }}</h4>

                        <a class="btn btn-primary text-white" href="{{ route('admin.taxes.index') }}">
                            {{ trans('tax.taxes') }}
                        </a>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($taxes as $tax)
                                    <tr>
                                        ...
                                        @can('restore_tax')
                                            <td class="row pl-3">
                                                <a href="{{ route('admin.taxes.restore', $tax->id) }}" class="btn btn-primary"
