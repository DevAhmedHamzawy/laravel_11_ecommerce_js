        ...
        <div class="col-xl-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ trans('supplier.trashed_suppliers') }}</li>
                </ol>
            </nav>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('supplier.trashed_suppliers') }}</h4>

                        <a class="btn btn-primary text-white" href="{{ route('admin.suppliers.index') }}">
                            ...
                            <tbody>
                                @foreach ($suppliers as $supplier)
                                    <tr>
                                        ...
                                        @can('restore_supplier')
                                            <td class="row pl-3">
                                                <a href="{{ route('admin.suppliers.restore', $supplier->id) }}"
