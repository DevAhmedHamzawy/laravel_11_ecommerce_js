        ...
        <div class="col-xl-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ trans('user.trashed_users') }}</li>
                </ol>
            </nav>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('user.trashed_users') }}</h4>

                        <a class="btn btn-primary text-white" href="{{ route('admin.users.index') }}">
                            {{ trans('user.users') }}
                        </a>
                    </div>
                </div>
