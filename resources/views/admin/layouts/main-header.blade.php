            ...
            <ul class="nav">
                <li class="">
                    <div class="dropdown  nav-itemd-none d-md-flex">
                        @switch($locale)
                            @case('en')
                                <a href="{{ route('language', 'en') }}" class="d-flex  nav-item nav-link pr-0 country-flag1"
                            ...
                            @case('ar')
                                <a href="{{ route('language', 'ar') }}" class="d-flex  nav-item nav-link pr-0 country-flag1"
                                    data-toggle="dropdown" aria-expanded="false">
                                    <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
                        ...
                        @switch($locale)
                            @case('ar')
                                <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                                    <a href="{{ route('language', 'en') }}" class="dropdown-item d-flex ">
                                        <span class="avatar  mr-3 align-self-center bg-transparent"><img
                                                src="{{ URL::asset('assets/img/flags/us_flag.jpg') }}" alt="img"></span>
                                        <div class="d-flex">
                                            <span class="mt-2">{{ trans('dashboard.english') }}</span>
                                        </div>
                                    </a>
                                </div>
                            @break
                            ...
                            @case('en')
                                <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                                    <a href="{{ route('language', 'ar') }}" class="dropdown-item d-flex ">
                                        <span class="avatar  mr-3 align-self-center bg-transparent"><img
                                                src="{{ URL::asset('assets/img/flags/egypt_flag.jpg') }}"
                                                alt="img"></span>
                                        <div class="d-flex">
                                            <span class="mt-2">{{ trans('dashboard.arabic') }}</span>
                                        </div>
                                    </a>
                                </div>
                            @break
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ auth()->user()->img_path }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt="" src="{{ auth()->user()->img_path }}"
                                        class=""></div>
                        ...
                        <a class="dropdown-item" href="{{ route('admin.logout') }}" style="margin-top:5px;"
                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i
                                class="bx bx-log-out"></i>{{ trans('dashboard.sign_out') }}</a>
